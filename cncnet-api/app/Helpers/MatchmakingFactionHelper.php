...
class MatchmakingFactionHelper
{
    ...
    /**
     * 2v2v2v2 (or any multi-team of 2): Each team has exactly 1 Allied and 1 Soviet player.
     *
     * @param array<string, QmMatchPlayer[]> $teams E.g. ['A' => [$p1, $p2], 'B' => [$p3, $p4], ...]
     */
    public static function assignMultiTeam(array $teams): void
    {
        foreach ($teams as $teamName => $players) {
            self::assignTeamAlliedAndSoviet($players, (string) $teamName);
        }
    }
