...
@section('feature')
    <x-hero-with-video video="{{ \App\Models\URLHelper::getVideoUrlbyAbbrev('ra2') }}">
        <x-slot name="title">Edit - {{ $ladder->name }}</x-slot>
        <x-slot name="description">
            View and manage ladders
        </x-slot>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="ladder_type" id="ladderTypes" class="form-control">
                                                    @foreach ($ladderTypes as $ladder_type)
                                                        <option value="{{ $ladder_type }}" @if ($ladder->ladder_type == $ladder_type) selected @endif>
                                                            {{ $ladder_type }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    ...
                                    <div class="player-box player-card" style="margin-bottom: 8px">
                                        ...
                                        <form method="POST" action="addSide">
                                            ...
                                            <div class="form-group col-md-8 mt-2" style="padding-right: 0;">
                                                ...
                                                <input id="name" name="name" type="text" class="form-control border" value="">
                                            </div>
                                    ...
                                    <div class="player-box player-card" style="margin-bottom: 8px">
                                        <form method="POST" action="mappool">
                                            ...
                                            <div class="form-group mb-2">
                                                ...
                                                <select id="mapPoolSelector" name="map_pool_id" class="form-control border">
                                                    <option value=""></option>
                                            ...
                                            <form method="POST" action="rules">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="show_map_preview" name="show_map_preview" class="form-control">
                                                        ...
                                                        <option value="0" @if (!$rule->show_map_preview) selected @endif>No
                                                        </option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group col-md-4">
                                                    <input type="checkbox" id="{{ $rule->ladder_id }}_use_elo_map_picker" name="use_elo_map_picker"
                                                        @if ($rule->use_elo_map_picker) checked @endif />
